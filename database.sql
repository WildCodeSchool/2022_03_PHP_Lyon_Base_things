...
Le saut se trouve juste à droite du "V" qui coupe la face, sur une vire.','Remarque 2','https://www.youtube.com/watch?v=hvRrBtc5h3I','https://www.base-jump.org/topo/images/thumb/f/f5/Bambi.jpg/400px-Bambi.jpg',1),
...
Retour en contournant la cascade par la droite (sentier).','Remarque 3','https://www.dailymotion.com/video/x2fu4ds','https://www.base-jump.org/topo/images/thumb/3/34/Clars.jpg/400px-Clars.jpg',1),
...
Arriver sous le saut, on monte par la droite et on rejoint facilement le bord où plusieurs exit sont possibles.','Remarque 4','https://www.youtube.com/watch?v=-eC-61OLkEQ','https://www.base-jump.org/topo/images/thumb/d/d6/Castel_Tournou.jpg/400px-Castel_Tournou.jpg',1),
...
D''autres départs sont envisageables, mais attention la paroi n''est pas régulière, surtout vers les hauteur d''ouverture.','Remarque 5','https://www.youtube.com/watch?v=-eC-61OLkEQ','https://www.base-jump.org/topo/images/thumb/d/d2/Chanabasse.jpg/400px-Chanabasse.jpg',1),
...
Départ Versant Allemont depuis le lieu dit Le Mollard conseillé pour le saut en WS. 4h en quasi autonavette.','Remarque 7','https://youtu.be/AG_3-KLHpM0','https://cdn.radiofrance.fr/s3/cruiser-production/2021/09/10db6eca-a34f-4efd-9a99-fd85e64c4ef7/870x489_wing_suit.jpg',1),
   ('Aiguillette Saint Michel','Aisne','France','Une static line (flèche verte) 80m maxi, Un saut d''aile (flèche rouge)','01:25:00',NULL,'Depuis le col de Marcieu, monter sur le plateau par le pas du ragris ou le pas de l''aulp du seuil. Monter à la station au sommet, le glisseur bas est évident.

Pour atteindre le saut de wingsuit descendre sur le gros pilier plein sud, 2 pas équipés de cordes à descendre un peu expos.','Remarque 8','https://www.youtube.com/watch?v=E6-Q2WXgwF0','https://www.base-jump.org/topo/images/thumb/e/ef/Aiguillette.png/400px-Aiguillette.png',1),
   ('Fou Allier !','Haute-Loire','France','75 mètres de verticale, 100 jusqu’au posé','00:10:00',NULL,'Bien vérifier l’axe de départ, en cas de grosse orientation à gauche les réflexes doivent être au rendez vous! ','Remarque 9','https://www.youtube.com/watch?v=3YZGaGYx8HU','https://static.actu.fr/uploads/2021/09/base-jump.jpeg',1),
...
Il est ensuite facile de trouver un exit convenable. Cordelette présente pour indiquer l''exit original.','Remarque 10','https://www.youtube.com/watch?v=l0B-jPHyMY4','https://www.base-jump.org/topo/images/thumb/8/86/Bondieu.jpg/400px-Bondieu.jpg',1);
