...
-- --------------------------------------------
DROP 
  DATABASE IF EXISTS base_things;
-- --------------------------------------------
...
VALUES 
  (
    'Barre de la Clue', 'Alpes-maritimes', 
    'France', '150m +', '00:20:00', '43.974205,6.998488', 
...
Le suivre en restant discret. Environ en 43.974205 , 6.998488 quitter le sentier vers l''Est et traverser la végétation dense vers l''exit, environ en 43.975625 , 7.003191 (progression pas facile).', 
  ...
  (
    'Bambi', 'Alpes-maritimes', 'France', 
    '65m', '00:30:00', '44.126244,6.872327', 
...
Le saut se trouve juste à droite du "V" qui coupe la face, sur une vire.', 
  ...
  (
    'Cascade de Clars', 'Alpes-maritimes', 
    'France', '60m', '00:10:00', '43.743690,6.753011', 
...
Retour en contournant la cascade par la droite (sentier).', 
  ...
  (
    'Castel Tournou', 'Alpes-maritimes', 
    'France', '70m', '01:00:00', '44.115727,7.617391', 
...
Arriver sous le saut, on monte par la droite et on rejoint facilement le bord où plusieurs exit sont possibles.', 
  ...
  (
    'Chanabasse', 'Alpes-maritimes', 
    'France', 'de 70m à 90m', '01:00:00', 
    '44.146421,6.833376', 'Dans le grand virage à gauche avant d''arriver à Chateauneuf d''Entraunes, tourner à droite et prendre la route partant vers le Nord, qui se transforme ensuite en piste après la chapelle.
...
D''autres départs sont envisageables, mais attention la paroi n''est pas régulière, surtout vers les hauteur d''ouverture.', 
  ...
  (
    'Chaudan', 'Alpes-maritimes', 'France', 
    '60m', '00:30:00', '44.033201,6.825770', 
...
Marcher maintenant sur la route vers le sud afin de rejoindre l''autre côté de la crête où se trouve le saut et proche d''un petit parking, monter dans le talus afin de rejoindre l''exit à vue.', 
  ...
  (
    'Amphibolite Brumeuse', 'Isère', 
    'France', 'Entre 220m et 2000m!!', 
    '04:00:00', '45.142400,5.988160', 
...
Départ Versant Allemont depuis le lieu dit Le Mollard conseillé pour le saut en WS. 4h en quasi autonavette.', 
  ...
  (
    'Aiguillette Saint Michel', 'Isère', 
    'France', 'Une static line (flèche verte) 80m maxi, Un saut d''aile (flèche rouge)', 
...
Pour atteindre le saut de wingsuit descendre sur le gros pilier plein sud, 2 pas équipés de cordes à descendre un peu expos.', 
  ...
  (
    'Bon dieu de Bon Dieu', 'Vaucluse', 
    'France', '50m', '00:20:00', '43.769291,5.347224', 
...
Première : Pierre Lebreton le 29 janvier 2015', 
  ...
  (
    'La petite gorge', 'Ain', 'France', 
    '65m', '00:20:00', '', 'Ce garer à l’entrée de Saint Sorlin (sud est) sur la d122, sur le parking du lycée, puis prendre le chemin de randonné qui traverse le village et qui monte de façon évidente à l’indication ign « petite gorge » le saut ce trouve en bas du champ dans l’axe du << p >> de petite entre les 2 parcelles de vignes.', 
...
Premiére: Pierre Lebreton 2015', 
  ...
  (
    'Le Dess', 'Ain', 'France', '100m', 
    '00:03:00', '', 'A la sortie de Saint Rambert en Bugey en direction de Chambéry, prendre la direction d’Evosges, dans la commune d’Evosges passer devant l’auberge (très réputée !), continuer la route qui monte sur le plateau et qui se transforme en chemin carrossable. A la première intersection, du chemin, prendre à gauche et continuer jusqu''à que le chemin s’arrête dans le dernier champ. Ensuite prendre à droite à travers bois en se rapprochant de la falaise', 
...
Première : Gabi Dematte et Denis Verchère en novembre 2001', 
  ...
  (
    'Rochers de la Falconnière', 'Ain', 
    'France', '70m', '00:30:00', '', 'De Serrières, prendre le chemin de randonnée qui monte au Rochers de la Falconnière, arriver sur le plateau prendre la direction du balcon de la falconnière, le saut ce trouve juste après la fin du champ.', 
...
Première: Pierre Lebreton 2015', 
  ...
  (
    'Tour d''Horizon', 'Ain', 'France', 
    '120m', '00:40:00', '', 'Se garer sur un parking sablé environ 1km après la sortie de Nantua, sur la route longeant le nord du lac. Continuer à pied sur 200 mètres et prendre le chemin à droite qui monte entre deux grillages. Suivre le sentier qui monte en pente douce, en suivant les panneaux indiquant "Tour d''horizon". Arrivé sur le chemin pour 4x4, le suivre en montant sur environ 500 mètre puis tourner à droite sur un sentier partant dans la forêt.
...
Au bout de 5-10 minutes, sortir du sentier en allant au sud. L''exit est à environ 50 mètres. Plusieurs départ possible, dont un en courant (3-4 pas d''élan) dans une zone un peu dégagée.', 
  ...
  (
    'Barrage de Castillon', 'Alpes-de-Haute-Provence', 
    'France', '120m', '00:05:00', '', 
...
Première : Timothée Maurel, et Pierre Lebreton le 25 aout 2017', 
  ...
  (
    'Bessey-en-Chaume', 'Alpes-de-Haute-Provence', 
    'France', '45m, 90m pour le posé', 
    '00:20:00', '', 'Du hameau de Clavoillon, monter au "Bas de Berfeu" (carte IGN) ne pas prendre à droite à la ferme de Berfeu, continuer encore 100m et prendre le chemin à droite (ça évite de traverser les habitations) traverser le champ en direction du "point de vue", 50m avant la fin du champ, traverser à travers la végétation (dense) pour arriver à la falaise.', 
  ...
  (
    'Chapelle Saint-Pons', 'Alpes-de-Haute-Provence', 
    'France', '100m au total', '00:40:00', 
    '44.134702 , 5.884476', 'Du village de Valbelle, marcher vers le Sud-Est sur le sentier pour monter à la chapelle (voir carte).
...
VALUES 
  (
    'Chapelle St-Trophisme', 'Alpes-de-Haute-Provence', 
    'France', '60m', '00:45:00', '', 'Se garer dans Robion ou le petit Robion et emprunter un des sentiers balisés montant à la chapelle et visibles sur la carte IGN.
...
Première : Guillaume Bernard le 29 juin 2013', 
  ...
  (
    'Chute de Charognes', 'Alpes-de-Haute-Provence', 
    'France', '100m', '00:15:00', '', 
...
Première : Timothée Maurel et Pierre Lebreton le 20 octobre 2018', 
  ...
  (
    'Clouet de la cabane', 'Alpes-de-Haute-Provence', 
    'France', 'au moins assez pour une static-line', 
    '01:30:00', '44.061111 , 6.315076', 
...
Continuer la route en marchant sur 200m et prendre le sentier à gauche. Suivre les sentiers vers le pas de Labaud, et une fois en haut, prendre vers le nord jusqu''à atteindre la première barre et trouver un exit potable.', 
  ...
  (
    'Clue de Chasteuil', 'Alpes-de-Haute-Provence', 
    'France', '100m', '01:10:00', '43.813565, 6.437970', 
...
Première : Timothée Maurel et Pierre Lebreton le 21 octobre 2018', 
  ...
  (
    'Clue de la Peine', 'Alpes-de-Haute-Provence', 
    'France', '45m', '00:20:00', '44.088231 , 6.389261', 
...
Possibilité de poser sur la piste après avoir voler dans la clue .', 
  ...
  (
    'Coréen Bleu', 'Alpes-de-Haute-Provence', 
    'France', '95m', '00:50:00', '44.444563 , 6.421808', 
...
Suivre le sentier de randonnée partant vers le Nord-Est en haut du Hameau. Celui va ensuite traverser le cours d''eau et remonter jusqu''au sommet du rocher où se trouve l''exit (Indication "Parual" sur la carte IGN). En haut et face au vide, descendre à droite jusqu''à l''exit, une petite dalle évidente après une zone d''arbres.', 
  ...
  (
    'Déferlante', 'Alpes-de-Haute-Provence', 
    'France', '150m', '01:30:00', '', 
...
L''exit se trouve sous le sommet (au niveau des piquets) sur une petite avancée sur laquelle il faudra descendre prudemment.', 
  ...
  (
    'East Coast Pérouré', 'Alpes-de-Haute-Provence', 
    'France', '100m', '00:40:00', '44.217262 , 6.27652', 
...
VALUES 
  (
    'Educh', 'Alpes-de-Haute-Provence', 
    'France', '100m', '01:00:00', '', 
...
Un cairn matérialise l''endroit exact.', 
    'Départ en courant.', '', 'assets/images/400px-Educhrochers627a5eeda4fa69.92101615.jpg', 
    1
  ), 
  (
    'Entrepierres W', 'Alpes-de-Haute-Provence', 
    'France', '75m', '00:30:00', '44.199896 , 5.984822', 
...
De là, tirer à l''Est dans la végétation pour trouver le vide et un exit (vers 44.199896 , 5.984822)', 
    'Ligne Haute tension', '', 'assets/images/400px-Entrepierrew627a5f52737240.93560508.png', 
    1
  ), 
  (
    'Estachon', 'Alpes-de-Haute-Provence', 
    'France', '50m', '00:30:00', '44.228511 , 6.045996', 
...
Une fois en haut, prendre à droite et suivre le vide direction Nord-Est sur environ 400m pour trouver l''exit en descendant une marche, environ en 44.228511 , 6.045996.', 
  ...
  (
    'Gorges de Saint-Pierre', 'Alpes-de-Haute-Provence', 
    'France', '120m', '01:45:00', '44.125999 , 6.618474', 
...
En auto-navette, il faudra environ 1h20 pour revenir à la voiture en crapahutant dans les pierrier pour récupérer la ligne de crête intermédiaire et le sentier de l''aller.', 
  ...
  (
    'Génépi de l''Ubay', 'Alpes-de-Haute-Provence', 
    'France', '45m', '00:30:00', '44.400111 , 6.518102', 
...
Première : Timothée Maurel et Pierre Lebreton en juin 2019 avec la contribution de Dgé Népi', 
  ...
  (
    'Géruen Vuvnir', 'Alpes-de-Haute-Provence', 
    'France', '140m', '01:20:00', '44.218083 , 6.178923', 
...
Première : Timothée Maurel, en avril 2021', 
  ...
  (
    'High Pérouré', 'Alpes-de-Haute-Provence', 
    'France', '100m', '01:15:00', '', 
    'De Digne les Bains, prendre direction Barles sur la D900a et rouler environ 15km jusqu''à la Clue du Pérouré.
...
Une fois en haut, longer le vide vers le sud et descendre sur l''exit en dé-escaladant la petite barre rocheuse grâce à un arbre.', 
  ...
  (
    'Issioule Connexion', 'Alpes-de-Haute-Provence', 
    'France', '100m', '01:15:00', '', 
...
VALUES 
  (
    'L''ami GN', 'Alpes-de-Haute-Provence', 
    'France', '400m (160 de verticale), 1100m en aile', 
    '02:00:00', '', 'Depuis St Paul sur Ubaye, suivre sur 8 km la D25. Se garer au départ du sentier PR Vallon des Houerts (à gauche). Le suivre jusqu’au pied de la grande face 1h(non visible depuis la vallée) l’exit se situe au sommet du piler de droite. Contourner la paroi par la droite en bord de crête jusqu''à un col, de là, grimper à gauche jusqu’au point haut. Et redescendre de 50 m pour rejoindre une épaule. Quelques passages d’escalades faciles.
...
Long vol à droite pour rejoindre la vallée, bonne finesse, attention au contre en cas de brise montante', 
  ...
  (
    'L''écaille du tripotanus', 'Alpes-de-Haute-Provence', 
    'France', '110m', '00:30:00', '44.273071 , 6.039163', 
...
Plusieurs exits possibles, l''original étant proche des débris de ce qui semble être une croix en bois (voir photo).', 
  ...
  (
    'La chambre du roi', 'Alpes-de-Haute-Provence', 
    'France', 'environ 100m (120m avec la projection)', 
    '00:40:00', '', 'Se garer à la gare d''Annot. Descendre la pente d''entrée de la gare et passer sous la voie à droite. De l''autre côté, prendre à droite puis tout droit jusqu''au départ du sentier de rando. Deux possibilité s''offre à vous, la rouge et la bleue (comme dans Matrix).
...
N''hésitez pas à leur passer le bonjour et à partager leur gîte!!', 
  ...
  (
    ...
    '150m', '01:00:00', '44.232709 , 6.251391', 
...
Première : Timothée Maurel et Pierre Lebreton en juin 2019', 
  ...
  (
    'Le Duc', 'Alpes-de-Haute-Provence', 
    'France', '300 mètres', '01:00:00', 
...
Descendre quelques mètres en contrebas du sommet vers le spot évident au-dessus du couloir Samson.', 
  ...
  (
    'Le Teillon', 'Alpes-de-Haute-Provence', 
    'France', '50m', '01:00:00', '43.829426, 6.563258', 
...
Première : Timothée Maurel en septembre 2019', 
  ...
  (
    'Le Vallonet', 'Alpes-de-Haute-Provence', 
    'France', '50m', '00:15:00', '44.225298, 6.268712', 
...
Première : Timothée Maurel et Pierre Lebreton en juin 2019', 
  ...
  (
    'Les Cadières de Brandis', 'Alpes-de-Haute-Provence', 
    'France', '90m', '02:00:00', '', 'Plusieurs options sont possibles :
...
VALUES 
  (
    'y', 'Ain', 'France', '2', '00:00:00', 
    '', 'd', '', '', 'assets/images/', 
    1
  ), 
  (
    'e', 'Ain', 'France', '1', '00:00:00', 
    '', 'd', '', '', 'assets/images/', 
    0
  ), 
  (
    'Le Mollard', 'Isère', 'France', 
    'entre 160 et 700 mètres', '00:10:00', 
  ...
  (
    'Bournillon', 'Isère', 'France', 
    'entre 400 et 700 mètres', '00:10:00', 
  ...
  (
    'Molaire Blues', 'Isère', 'France', 
    'entre 300 et 800 mètres', '00:30:00', 
  ...
  (
    'Courage Malko', 'Isère', 'France', 
    'entre 260 et 700 mètres', '00:30:00', 
  ...
  (
    'Roche Cordant', 'Isère', 'France', 
    'entre 160 et 550 mètres', '00:05:00', 
...
VALUES 
  (
    'L''oiseau noir et le Cochon', 'Vosges', 
    'France', '49 m , avec un petit +3m à 28m', 
    '00:20:00', '', 'A environ 10 Km au sud-ouest de Colmar rejoindre le village de Voegtlinshoffen. Arrivé au village prendre la direction de l''Abbaye de Marbach et se garer à proximité de celle-ci. Monter droit dedans en direction du point le plus haut de l''ancienne carrière de Marbach.', 
    'Attention au posé ! Bien que l''Exit soit un des sauts , voir le saut le plus simple des " E " des Vosges , le posé n''est pas à prendre à la légère . Il faut vraiment se méfier de l''aérologie de cette zone de saut. En conditions "normales" le saut reste assez simple en terme d''exit et de posé, mais en cas de vent ( même faible) ou de problèmes techniques ( prise de commandes , grosse orientation droite ) la zone de posé 5 étoiles se transforme très vite en Jurassic Park. Avec une multitude d''obstacles pas très sympa ( cailloux, ronces , arbustes) dans la zone 20 à 40 m . Ainsi toujours prévoir de bonnes protections personnels lors du saut. Vos membres inférieurs ( et le reste...)vous en remercieront !', 
    'https://www.youtube.com/watch?v=WuxbYT76Yik', 
    'assets/images/400px-L''oiseau_noir_et_le_cochon2627ab6b14775d5.26627926.jpg', 
    1
  ), 
  (
    'The Piggysher', 'Vosges', 'France', 
    'Variable, la falaise en elle même fait dans les 45m , mais le saut en lui même fait 30 m à cause de la cime des arbres en contre bas.', 
    '00:15:00', '', 'Du col de la Schlucht prendre la D 61 en direction du lac Blanc sur 2 km environs. Après être tombé sur un petit parking, prendre le sentier qui mène au rocher du Tanet ( Gr5) . L''exit se trouve dans la partie Nord du Rocher , légèrement en contre bas du sentier .', 
    'Il existe un exit annexe une dizaine de mètres à droite de l''exit initial , avec les mêmes éléments que le premier. Les 2 sauts restent des static-line engagées . Il est préférable de confirmer les mesures concernant l''avancé des arbres dans la zone des 30 / 35 m vu qu''ils restent la principale difficulté du saut et qu''ils peuvent être amené à évoluer avec le temps .', 
    'https://www.youtube.com/watch?v=a6g61KXXslk', 
    'assets/images/550px-Exit_The_Piggysher_2627ab7b36943b9.75873982.jpeg', 
    1
  ), 
  (
    'Un petit cochon pendu au buisson', 
    'Vosges', 'France', '42m au posé, env 30m rock drop, Arbres à 24m sur la gauche', 
    '00:15:00', '', 'Prendre la direction de Gueberschwihr et se rendre sur le parking "Vieux Guebershwihr". A partir du parking emprunter un petit sentier ( plein EST) sur 500m environ afin d''arriver "au pied d''une montée orientée vers le Nord.', 
    'Attention saut technique, la présence d''arbres à 24m sur la gauche et l''absence d''échappatoire si un orientation droite fait de ce saut un saut assez technique et engagé. Lors du calcul initial de pente et de trajectoire, j''ai conclu à un manque de 3m sous les arbres d''entrées (-42m ; + 38m au sol sur l''entrée de la zone de poser). Vu que le point d''impacte avec les arbustes était à hauteur de suspentes (donc la chute final serait de l''ordre du mètre), j''ai pris la décision de taper full vitesse entre les 2 arbustes, afin de garantir la potentielle casse de branches des petits arbustes. Une branche s''étant pétée, le tunnel est fait pour les suivants. Cependant vu que le saut est déjà très technique sans cela, je compte me rendre de nouveau sur la zone de poser afin de faire tomber les 2 arbustes d''entrée. Un mise à jour futur du topo le précisera. Le retour de la dz sur le sentier est assez casse gueule à travers les bois, pensez à affuter le mode "Sanglination brutal". Attention de ne pas se faire mal au posé, surtout si vous êtes seul, car cela rendrait le retour sur le sentier quasi impossible…( donc vérifiez si vous avez du réseau tél, le réseau orange est excellent sur zone)', 
    'https://youtu.be/E0borQ7y_C8', 
    'assets/images/400px-Un_petit_cochon_pendu_au_buisson_exit627ab8b0eb68a8.81705520.jpg', 
    1
  ), 
  (
    'Aiguille de la Praina', 'Savoie', 
    'France', '1300m de dénivelé au max, finesse obligatoire 1.5 pour les premiers posés, 2.5 au plus loin', 
    '01:30:00', '', 'Depuis Bourg Saint Maurice, navette jusqu''au chalet de Praina.

Ensuite marcher en direction de l''aiguille de la Praina, plutôt à droite vers la ligne THT pour basculer dans la pente est et passer sous l''aiguille de la Praina dans les raides pentes de la pente est.

Contourner en passant sous les épaules en rocher, c''est raide et exposé mais toujours en herbe, puis remonter logiquement une rampe en herbe à la fin sur 200m jusqu''à apercevoir les différents exits possibles.

Vers 2380m exit le plus haut accessible depuis ce versant. Un spit en place pour descendre avec une sangle pour une belle plateforme, sinon possibilité de pousser d''en haut.

Lignes de vols rigolotes à explorer. Réalisation en Pantz à faire !', 
    'Lieu : Aiguille de la Praina - Vallée des Chapieux
Hauteur : 1300m de dénivelé au max, finesse obligatoire 1.5 pour les premiers posés, 2.5 au plus loin
Matériel : le pied montagnard
Posé : possibilité de poser à plein d''endroits, le plus loin étant le captage d''eau des anciens thermes à 1063.
Première : le 18/06/19 par Julien Millot et Freddy Montigny.', 
    '', 'assets/images/Chapieux627ab9cacf9214.45318482.jpg', 
    1
  );
-- --------------------------------------------
...
VALUES 
  (
    1, 'Cécé de la voile', 'Chaton69', 
    'Russier', 'Célie', '1986-04-15', 
    'celie.russier@gmail.com', '17 Rue Delandine, 69002 Lyon', 
    1
  ), 
  (
    2, 'Chris du grand saut', 'Gargamel69', 
    'Cuzin', 'Christopher', '1991-01-01', 
    'ed.ed1009@hotmail.fr', '17 Rue Delandine, 69002 Lyon', 
    1
  ), 
  (
    3, 'Gautier le Sans Glisseur', 'Mistefrizz69', 
    'Fondevila', 'Gautier', '1870-12-24', 
    'fondevila.gautier@gmail.com', 
    '17 Rue Delandine, 69002 Lyon', 
    1
  ), 
  (
    4, 'Antho reste en bas', 'Lola69', 
    'Gouton', 'Anthony', '1988-07-20', 
    'anthony.gouton.wcs@gmail.com', 
    '17 Rue Delandine, 69002 Lyon', 
    1
  ), 
  (
    5, 'Max la menace', 'Lorel73', 'Robert', 
    'Maxime', '1985-04-22', 'maxlamenace@gmail.com', 
    '2-14 Rue du Sénat de Savoie, 73000 Chambéry', 
    2
  ), 
  (
    6, 'Hortense la balance', 'LoupBoutin38', 
    'Louïson', 'Hortense', '1990-06-05', 
    'labalance@outlook.com', '1 Pl. aux Herbes, 38000 Grenoble', 
    2
  ), 
  (
    7, 'Le caskouyeu', 'Beton74', 'Rodriguez', 
    'Benjamin', '1986-01-16', 'benjadu74@live.fr', 
    '26 Rue Royale, 74000 Annecy', 
    2
  ), 
  (
    8, 'a', NULL, NULL, NULL, NULL, NULL, 
    NULL, NULL
  ), 
  (
    9, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    10, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    11, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    12, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    13, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    14, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    15, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    16, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    17, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    18, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    19, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    20, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    21, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    22, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    23, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    24, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    25, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    26, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  ), 
  (
    27, 'Gautier', NULL, NULL, NULL, NULL, 
    NULL, NULL, NULL
  );
-- --------------------------------------------
...
VALUES 
  (
    1, 5, '2022-03-13', 4, 1, 'non', 'oui', 
    'oui', 'Ensoleillé', '5 km/h', 'https://www.youtube.com/watch?v=mVzEf03SRZM', 
  ...
  (
    2, 7, '2022-03-15', 6, 3, 'oui', 'oui', 
    'oui', 'Nuageux', '10 km/h', 'https://www.youtube.com/watch?v=yP87mNNsc04', 
  ...
  (
    3, 7, '2022-03-17', 3, 2, 'non', 'non', 
    'non', 'Ensoleillé', 'Pas de vent', 
  ...
  (
    4, 6, '2022-04-02', 3, 5, 'oui', 'non', 
    'non', 'Neige', '15 km/h', 'https://www.youtube.com/watch?v=FNdzA_UUdIc', 
  ...
  (
    5, 6, '2022-04-10', 8, 2, 'non', 'oui', 
    'non', 'Ensoleillé', '20 km/h', 
  ...
  (
    6, 5, '2022-04-11', 5, 3, 'oui', 'oui', 
    'oui', 'Nuageux', '10 km/h', 'https://www.youtube.com/watch?v=JQy_ZhYkn_Q', 
  ...
  (
    7, 5, '2022-04-12', 5, 1, 'oui', 'oui', 
    'oui', 'Ensoleillé', 'Pas de vents', 
  ...
  (
    8, 6, '2022-04-12', 7, 1, 'non', 'non', 
    'oui', 'Nuageux', '15 km/h', 'https://www.youtube.com/watch?v=dnjHm6WyaAc', 
  ...
  (
    9, 6, '2022-04-13', 1, 3, 'oui', 'oui', 
    'non', 'Mitigé', '5 km/h', 'https://www.youtube.com/watch?v=F1fJRz4iWqs', 
  ...
  (
    12, 9, '2017-04-03', 51, 2, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    13, 10, '2017-04-04', 51, 2, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    14, 11, '2017-04-08', 51, 2, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    15, 12, '2017-04-08', 55, 2, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    16, 13, '2017-04-15', 55, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    17, 14, '2017-04-16', 55, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    18, 15, '2017-04-19', 54, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', 'Pas bien de faire ce saut en lisse ...'
  ), 
  (
    19, 16, '2017-04-19', 54, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    20, 17, '2017-05-21', 54, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    21, 18, '2017-05-21', 54, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    22, 19, '2017-05-26', 54, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    23, 20, '2017-05-26', 54, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    24, 21, '2017-05-26', 54, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    25, 22, '2017-06-10', 56, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    26, 23, '2017-06-24', 54, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    27, 24, '2017-06-24', 53, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    28, 25, '2017-08-27', 57, 3, 'Zak 3', 
    'Troll 305', '', '', '', '', '', ''
  ), 
  (
    29, 26, '2019-05-10', 58, 4, 'Zak 3', 
    'Troll 305', 'Phoenix-Fly - Regular', 
    '', '', '', '', ''
  ), 
  (
    30, 27, '2019-05-30', 56, 4, 'Zak 3', 
    'Troll 305', 'Phoenix-Fly - Regular', 
    '', '', '', '', ''
  );
