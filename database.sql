...
-- --------------------------------------------
INSERT INTO `exit` (name,department,country,height,access_duration,gps_coordinates,comment,video,image) VALUES
...
Le suivre en restant discret. Environ en 43.974205 , 6.998488 quitter le sentier vers l''Est et traverser la végétation dense vers l''exit, environ en 43.975625 , 7.003191 (progression pas facile).','https://www.youtube.com/watch?v=mVzEf03SRZM','https://www.base-jump.org/topo/images/thumb/c/cf/Clue.png/400px-Clue.png'),
...
Le saut se trouve juste à droite du "V" qui coupe la face, sur une vire.','https://www.youtube.com/watch?v=hvRrBtc5h3I','https://www.base-jump.org/topo/images/thumb/f/f5/Bambi.jpg/400px-Bambi.jpg'),
...
Retour en contournant la cascade par la droite (sentier).','https://www.dailymotion.com/video/x2fu4ds','https://www.base-jump.org/topo/images/thumb/3/34/Clars.jpg/400px-Clars.jpg'),
...
Arriver sous le saut, on monte par la droite et on rejoint facilement le bord où plusieurs exit sont possibles.','https://www.youtube.com/watch?v=-eC-61OLkEQ','https://www.base-jump.org/topo/images/thumb/d/d6/Castel_Tournou.jpg/400px-Castel_Tournou.jpg'),
...
D''autres départs sont envisageables, mais attention la paroi n''est pas régulière, surtout vers les hauteur d''ouverture.','https://www.youtube.com/watch?v=-eC-61OLkEQ','https://www.base-jump.org/topo/images/thumb/d/d2/Chanabasse.jpg/400px-Chanabasse.jpg'),
...
Marcher maintenant sur la route vers le sud afin de rejoindre l''autre côté de la crête où se trouve le saut et proche d''un petit parking, monter dans le talus afin de rejoindre l''exit à vue.','https://www.youtube.com/watch?v=S9ErwpqMKbg','https://www.base-jump.org/topo/images/thumb/5/55/Chaudan.jpg/400px-Chaudan.jpg'),
...
Départ Versant Allemont depuis le lieu dit Le Mollard conseillé pour le saut en WS. 4h en quasi autonavette.','https://youtu.be/AG_3-KLHpM0','https://cdn.radiofrance.fr/s3/cruiser-production/2021/09/10db6eca-a34f-4efd-9a99-fd85e64c4ef7/870x489_wing_suit.jpg'),
...
Pour atteindre le saut de wingsuit descendre sur le gros pilier plein sud, 2 pas équipés de cordes à descendre un peu expos.','https://www.youtube.com/watch?v=E6-Q2WXgwF0','https://www.base-jump.org/topo/images/thumb/e/ef/Aiguillette.png/400px-Aiguillette.png'),
   ('Fou Allier !','Haute Loire','France','75 mètres de verticale, 100 jusqu’au posé','00:10:00',NULL,'Bien vérifier l’axe de départ, en cas de grosse orientation à gauche les réflexes doivent être au rendez vous! ','https://www.youtube.com/watch?v=3YZGaGYx8HU','https://static.actu.fr/uploads/2021/09/base-jump.jpeg'),
...
Il est ensuite facile de trouver un exit convenable. Cordelette présente pour indiquer l''exit original.','https://www.youtube.com/watch?v=l0B-jPHyMY4','https://www.base-jump.org/topo/images/thumb/8/86/Bondieu.jpg/400px-Bondieu.jpg');
