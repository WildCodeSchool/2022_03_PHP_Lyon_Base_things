...
Retour en contournant la cascade par la droite (sentier).','Remarque 3 1234567899','https://www.dailymotion.com/video/x2fu4ds','assets/images/400px-Coca626d7880591ce8.31744037.jpg'),
...
Départ Versant Allemont depuis le lieu dit Le Mollard conseillé pour le saut en WS. 4h en quasi autonavette.','Remarque 7','https://youtu.be/AG_3-KLHpM0','assets/images/400px-Ansage626d77c0ced749.50863894.jpg'),
	 ('Aiguillette Saint Michel','Chartreuse','France','Une static line (flèche verte) 80m maxi, Un saut d''aile (flèche rouge)','01:25:00','','Depuis le col de Marcieu, monter sur le plateau par le pas du ragris ou le pas de l''aulp du seuil. Monter à la station au sommet, le glisseur bas est évident.
